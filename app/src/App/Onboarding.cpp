...
StackPanel Onboarding::BuildReferral() {
  ...
  // the gold king-frog panel (android IntroductionReferral and the Account
  // "Refer and earn" page show the same panel alone; its bar is the only
  // referral progress bar on the step)
