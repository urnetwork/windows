...
// to a provider client id. Returns a FrameworkElement, not the base UIElement,
// because the callers place it with Grid::SetColumn, whose overload takes a
// FrameworkElement.
winrt::Microsoft::UI::Xaml::FrameworkElement MakeIdenticonBadge(
